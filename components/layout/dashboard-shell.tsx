...
export function DashboardShell({ children }: DashboardShellProps) {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(191,219,254,0.45),_transparent_30%),linear-gradient(to_bottom,_#f8fbff,_#eef4ff)]">
      <div className="mx-auto grid min-h-screen max-w-7xl gap-6 px-4 py-4 lg:grid-cols-[260px_1fr] lg:px-6">
        <aside className="rounded-[28px] border border-white/70 bg-slate-950 px-5 py-6 text-slate-100 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.75)]">
            ...
            <div>
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Northstar Labs</p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 rounded-2xl border border-blue-400/20 bg-blue-500/10 p-4">
            ...
            <p className="mt-3 text-sm text-slate-300">
              128 items are ready for theme labeling and sentiment review.
            </p>
        ...
        <div className="flex min-h-screen flex-col gap-6">
          <header className="rounded-[28px] border border-slate-200/80 bg-white/85 p-4 shadow-sm backdrop-blur">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Badge variant="indigo">Northstar Labs</Badge>
                <Badge variant="outline">Analyst Mode</Badge>
                <Button variant="secondary" className="gap-2">
                  <Bell className="h-4 w-4" />
                  Alerts
                </Button>
                <button className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-left shadow-sm">
                  <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-blue-100 text-sm font-semibold text-blue-700">
                    AR
                  </div>
                  <div>
                    <p className="text-sm font-medium text-slate-900">Ariana Rao</p>
          ...
          <main className="flex-1 rounded-[28px] border border-slate-200/80 bg-white/90 p-5 shadow-sm backdrop-blur sm:p-6">
            {children}
          </main>
        </div>
      </div>
